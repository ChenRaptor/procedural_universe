...
Atmosphere::Atmosphere(unsigned int subdivisions, float radius, Color atmosphereColor) :
...
void Atmosphere::generate() {
    ...
    for (size_t i = 0; i < vertexCount; ++i) {
        ...
        _sphereVertices[9 * i + 0] = _radius * v.x;
        _sphereVertices[9 * i + 1] = _radius * v.y;
        _sphereVertices[9 * i + 2] = _radius * v.z;

        _sphereVertices[9 * i + 3] = _atmosphereColor.r;
        _sphereVertices[9 * i + 4] = _atmosphereColor.g;
        _sphereVertices[9 * i + 5] = _atmosphereColor.b;
